Relayers may choose to use a variety of different strategies for matching orders in order to maximize revenue. The following is an incomplete list of strategies and explanations:
