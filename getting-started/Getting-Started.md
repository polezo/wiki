...
#### Test Networks
Development and testing is aided by running in your own local test network. This allows you to quickly deploy and interact with contracts without it costing real ETH. [Ganache](https://github.com/trufflesuite/ganache) is a great tool for a local development network. This software is an approximation of an actual network, so we recommend you also test on Kovan, Rinkeby, or Ropsten before going to Mainnet.

Rather than running your own Ethereum Node to connect to a network, many developers utilize [INFURA](https://infura.io/), they provide the public with a gateway to Ethereum. You can use INFURA to connect to Main Network and various test networks like Kovan.

It is difficult to get a sufficient amount of ETH to deploy your contracts and begin testing on these networks. We have created a faucet which can dispense small amounts of ETH to your account. Navigate over to the [0x Portal](https://0xproject.com/portal/balances) with Metamask installed while you're connected to the Kovan Network and click Request to receive some free test ETH!
